...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height: 236px;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo $modalidade[0]['nome']; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <?php
            ...
            <div>
                ...
                <a href="<?php echo base_url('Atividade/incluir/'.$modalidade[0]['id']); ?>"> Cadastrar Atividade</a>
                <br>
                <br>
            </div>
            <!-- /.row -->
                            ...
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <thead>
                                            <?php
                                                if (in_array($modalidade[0]['id'], [1, 2, 3])) {
                                                    $label = 'Distância percorrida';
                                                } else if (in_array($modalidade[0]['id'], [4, 6])){
                                                    $label = 'Pontos marcados';
                                                } else if (in_array($modalidade[0]['id'], [5])) {
                                                    $label = 'Gols marcados';
                                                }
                                            ?>
                                            <tr role="row">
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 207px;">Descrição atividade
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 108px;">Data
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 188px;"><?php echo $label; ?>
                                                </th>
                                            </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr class="gradeA <?php echo $class; ?>" role="row">
                                            <td class="sorting_1"><?php echo $row['descricao']; ?></td>
                                            <td class=""><?php echo $row['data']; ?></td>
                                            <td class="center"><?php echo $row['pontuacao']; ?></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
