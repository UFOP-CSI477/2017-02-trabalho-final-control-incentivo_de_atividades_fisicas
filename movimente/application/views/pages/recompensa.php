...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height: 236px;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Recompensas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <?php
                            ...
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150px;">Modalidade
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 200;">Descrição
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 50;">Troféu
                                                </th>
                                            </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            ...
                                            foreach($recompensas as $row) {
                                                ...
                                                $i++;
                                                if (empty($row['recompensaAdquirida'])) {
                                                    if ($j == 0) {
                                                        $img = base_url('assets/img/first-lock.png');
                                                    } else if ($j == 1) {
                                                        $img = base_url('assets/img/silver-lock.png');
                                                    } else {
                                                        $img = base_url('assets/img/gold-lock.png');
                                                    }
                                                } else {
                                                    if ($j == 0) {
                                                        $img = base_url('assets/img/first.png');
                                                    } else if ($j == 1) {
                                                        $img = base_url('assets/img/silver.png');
                                                    } else {
                                                        $img = base_url('assets/img/gold.png');
                                                    }
                                                }
                                                $j++;
                                                $j = $j == 3 ? 0 : $j;
                                        ...
                                        <tr class="gradeA <?php echo $class; ?>" role="row">
                                            <td class="sorting_1"><?php echo $row['modalidade']; ?></td>
                                            <td class=""><?php echo $row['descricao']; ?></td>
                                            <td class="center"><img src="<?php echo $img; ?>"></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
