    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">MovimenteSE</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="<?php echo base_url('Atividade/incluir/'.$modalidade[0]['id']); ?>" onsubmit="myButton.disabled = true; return true;">
                                        <fieldset>
                                            <?php
                                                if ($msg = get_msg()) {
                                                    echo $msg;
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="pontuacao" class="form-control">
                                            </div>
                                            <input type="submit" class="btn btn-default" name="myButton" value="Confirmar">    
                                        </fieldset>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
